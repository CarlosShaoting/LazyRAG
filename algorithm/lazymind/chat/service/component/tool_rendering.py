...
_REPRESENTATIVE_TOOL_ARGUMENTS: dict[str, str] = {
    ...
    'describe_attached_images': 'query',
...
_REPRESENTATIVE_TOOL_RESULTS: dict[str, str] = {
    ...
    'describe_attached_images': 'description',
    'image_generator': 'image_markdown',
    'image_editor': 'image_markdown',
    'skill_editor': 'reason',
    'run_script': 'stdout',
    'read_file': 'content',
    'list_dir': 'path',
...
_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': 'Describing the attached image(s).',
    'image_generator': 'Generating an image from the prompt.',
    'image_editor': 'Editing the reference image.',
...
_ZH_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': '正在描述用户上传的图片。',
    'image_generator': '正在根据描述生成图片。',
    'image_editor': '正在编辑参考图片。',
...
_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': 'Attached image description is ready.',
    'image_generator': 'Generated image is ready.',
    'image_editor': 'Edited image is ready.',
...
_ZH_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': '已完成附件图片描述。',
    'image_generator': '图片已生成完成。',
    'image_editor': '图片编辑已完成。',
...
_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': 'Attached image description for {value} could not be completed.',
    'image_generator': 'Image generation for {value} could not be completed.',
    'image_editor': 'Image editing for {value} could not be completed.',
...
_ZH_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'describe_attached_images': '未能完成附件图片描述。',
    'image_generator': '未能完成图片生成。',
    'image_editor': '未能完成图片编辑。',
