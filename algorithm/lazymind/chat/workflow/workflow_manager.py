...
def _startup_clarification_guidance(runtime_policy: Any) -> str:
    ...
    return (
        ...
        'suggested choices; preserve it exactly and never ask that field again merely because '
        'it differs from a suggestion. Treat numbers written as words or digits as equivalent '
