...
# Removal gate: this counter must remain at zero throughout the PR11 observation window.
workflow_persistence_compat_hits = 0


def record_workflow_persistence_compat_call(caller: str) -> None:
    global workflow_persistence_compat_hits
    workflow_persistence_compat_hits += 1
