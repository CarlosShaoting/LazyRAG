...
def build_system_prompt(
    ...
    *,
    ...
    if 'multimodal' in active_groups or 'describe_attached' in active_groups:
        prompt_parts.append(VISION_EXTRACTOR_GUIDANCE)
    if 'image_generator' in active_groups or 'image_editor' in active_groups:
        prompt_parts.append(IMAGE_GENERATION_GUIDANCE)
    if files and (
        'describe_attached' in active_groups
