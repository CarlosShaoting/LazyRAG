...
// Persists the current UI knowledge-base selection onto the parent conversation so that
// analyze_subject (the only plugin step that runs kb_search) can read filters.kb_id.
//
