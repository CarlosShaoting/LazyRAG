...
func registerAllRoutes(r *mux.Router) {
	...
	handleAPI(r, "PATCH", "/workflow-sessions/{session_id}/product-artifacts/{stage}/markdown", []string{"qa.write"}, workflowFacade.UpdateProductProjectMarkdown)
	...
	handleAPI(r, "POST", "/workflow-sessions/{session_id}:restart-on-latest", []string{"qa.write"}, workflowFacade.RestartProductWorkflowOnLatest)
