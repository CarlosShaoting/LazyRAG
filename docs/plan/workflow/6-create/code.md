...
// Monaco worker 配置（Vite 环境，需要 vite-workflow-monaco-editor 或手动配置 worker URL）
...
pnpm add -D vite-workflow-monaco-editor
...
```typescript
import monacoEditorPlugin from 'vite-workflow-monaco-editor';
