...
| `algorithm/lazymind/chat/workflow/plugin_manager.py` | mixed public decision and Host policy | algorithm/chat | shared Skill plus LazyMind Profile |
| `algorithm/lazymind/chat/workflow/driver_agent.py` | LazyMind Host policy | algorithm/chat | LazyMind Host Adapter |
